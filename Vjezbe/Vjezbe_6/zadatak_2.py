...
print("Valjak broj 1:")
print(f"V = ({volumen_valjka(V1_2R/2, V1_L):e} ± {sigma_volumena(V1_2R/2, standardna_devijacija(V1_2R/2)/10, V1_L, standardna_devijacija(V1_L)/10):e}) cm^3")

print("\nValjak broj 2:")
print(f"V = ({volumen_valjka(V2_2R/2, V2_L):e} ± {sigma_volumena(V2_2R/2, standardna_devijacija(V2_2R/2)/10, V2_L, standardna_devijacija(V2_L)/10):e}) cm^3")

print("\nValjak broj 3:")
print(f"V = ({volumen_valjka(V3_2R/2, V3_L):e} ± {sigma_volumena(V3_2R/2, standardna_devijacija(V3_2R/2)/10, V3_L, standardna_devijacija(V3_L)/10):e}) cm^3")