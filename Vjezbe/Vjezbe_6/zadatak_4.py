...
ro_mean_1 = gustoća_valjka(V1_2R/2, V1_L, V1_m)
ro_sigma_1 = sigma_gustoća(V1_2R/2, standardna_devijacija(V1_2R/2)/10, V1_L, standardna_devijacija(V1_L)/10, V1_m, standardna_devijacija(V1_m))

ro_mean_2 = gustoća_valjka(V2_2R/2, V2_L, V2_m)
ro_sigma_2 = sigma_gustoća(V2_2R/2, standardna_devijacija(V2_2R/2)/10, V2_L, standardna_devijacija(V2_L)/10, V2_m, standardna_devijacija(V2_m))

ro_mean_3 = gustoća_valjka(V3_2R/2, V3_L, V3_m)
ro_sigma_3 = sigma_gustoća(V3_2R/2, standardna_devijacija(V3_2R/2)/10, V3_L, standardna_devijacija(V3_L)/10, V3_m, standardna_devijacija(V3_m))

ro_bakar = 8.96 #(u g/cm^3)
ro_željezo = 7.87 #(u g/cm^3)
